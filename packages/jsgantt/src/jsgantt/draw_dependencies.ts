        ...
        for (let k = 0; k < n; k++) {
          ...
          if (vTask >= 0 && vList[vTask].getGroup() != 2) {
            if (vList[vTask].getVisible() == 1) {
              ...
              var cssClass =
                'gDepId' + vList[vTask].getID() + ' ' + 'gDepNextId' + vList[i].getID();
              ...
              if (dependedData && dependedData.pID && nextDependedData && nextDependedData.pID) {
                cssClass +=
                  ' gDepDataId' + dependedData.pID + ' ' + 'gDepNextDataId' + nextDependedData.pID;
              }

              if (vDependType[k] == 'SS')
                this.drawDependency(
                  vList[vTask].getStartX() - 1,
                  vList[vTask].getStartY(),
                  vList[i].getStartX() - 1,
                  vList[i].getStartY(),
                  'SS',
                  cssClass + ' gDepSS',
