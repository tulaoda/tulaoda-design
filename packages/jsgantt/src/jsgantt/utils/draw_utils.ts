...
export const makeInput = function (
  formattedValue,
  editable,
  type = 'text',
  value = null,
  ...
  if (editable) {
    switch (type) {
      ...
      case 'cost':
        return `<input class="gantt-inputtable" type="number" max="100" min="0" value="${
          value ? value : ''
        }">`;
      default:
    ...
    if (this.vFormatArr.join().toLowerCase().indexOf('hour') != -1)
      addFormatListeners(
        ...
        newNode(
          vTmpDiv,
          'span',
          this.vDivId + 'formathour' + pPos,
          'gformlabel' + (this.vFormat == 'hour' ? ' gselected' : ''),
          this.vLangs[this.vLang]['hour'],
        ),
      );
    ...
    if (this.vFormatArr.join().toLowerCase().indexOf('day') != -1)
      addFormatListeners(
        ...
        newNode(
          vTmpDiv,
          'span',
          this.vDivId + 'formatday' + pPos,
          'gformlabel' + (this.vFormat == 'day' ? ' gselected' : ''),
          this.vLangs[this.vLang]['day'],
        ),
      );
    ...
    if (this.vFormatArr.join().toLowerCase().indexOf('week') != -1)
      addFormatListeners(
        ...
        newNode(
          vTmpDiv,
          'span',
          this.vDivId + 'formatweek' + pPos,
          'gformlabel' + (this.vFormat == 'week' ? ' gselected' : ''),
          this.vLangs[this.vLang]['week'],
        ),
      );
    ...
    if (this.vFormatArr.join().toLowerCase().indexOf('month') != -1)
      addFormatListeners(
        ...
        newNode(
          vTmpDiv,
          'span',
          this.vDivId + 'formatmonth' + pPos,
          'gformlabel' + (this.vFormat == 'month' ? ' gselected' : ''),
          this.vLangs[this.vLang]['month'],
        ),
      );
    ...
    if (this.vFormatArr.join().toLowerCase().indexOf('quarter') != -1)
      addFormatListeners(
        ...
        newNode(
          vTmpDiv,
          'span',
          this.vDivId + 'formatquarter' + pPos,
          'gformlabel' + (this.vFormat == 'quarter' ? ' gselected' : ''),
          this.vLangs[this.vLang]['quarter'],
        ),
      );
  } else {
