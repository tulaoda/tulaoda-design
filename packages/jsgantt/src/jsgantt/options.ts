...
export const includeGetSet = function () {
  ...
  this.setUseFade = function (pVal: any) {
    this.vUseFade = pVal;
  };
  this.setUseMove = function (pVal: any) {
    this.vUseMove = pVal;
  };
  this.setUseRowHlt = function (pVal: any) {
    this.vUseRowHlt = pVal;
  };
  this.setUseToolTip = function (pVal: any) {
    this.vUseToolTip = pVal;
  };
  this.setUseSort = function (pVal: any) {
    this.vUseSort = pVal;
  };
  this.setUseSingleCell = function (pVal: any) {
  ...
  this.setShowRes = function (pVal: any) {
    this.vShowRes = pVal;
  };
  this.setShowDur = function (pVal: any) {
    this.vShowDur = pVal;
  };
  this.setShowComp = function (pVal: any) {
    this.vShowComp = pVal;
  };
  this.setShowStartDate = function (pVal: any) {
    this.vShowStartDate = pVal;
  };
  this.setShowEndDate = function (pVal: any) {
    this.vShowEndDate = pVal;
  };
  this.setShowPlanStartDate = function (pVal: any) {
    this.vShowPlanStartDate = pVal;
  };
  this.setShowPlanEndDate = function (pVal: any) {
    this.vShowPlanEndDate = pVal;
  };
  this.setShowCost = function (pVal: any) {
    this.vShowCost = pVal;
  };
  this.setShowAddEntries = function (pVal: any) {
    this.vShowAddEntries = pVal;
  };
  this.setShowTaskInfoRes = function (pVal: any) {
    this.vShowTaskInfoRes = pVal;
  };
  this.setShowTaskInfoDur = function (pVal: any) {
    this.vShowTaskInfoDur = pVal;
  };
  this.setShowTaskInfoComp = function (pVal: any) {
    this.vShowTaskInfoComp = pVal;
  };
  this.setShowTaskInfoStartDate = function (pVal: any) {
    this.vShowTaskInfoStartDate = pVal;
  };
  this.setShowTaskInfoEndDate = function (pVal: any) {
    this.vShowTaskInfoEndDate = pVal;
  };
  this.setShowTaskInfoNotes = function (pVal: any) {
    this.vShowTaskInfoNotes = pVal;
  };
  this.setShowTaskInfoLink = function (pVal: any) {
    this.vShowTaskInfoLink = pVal;
  };
  this.setShowTaskCaption = function (pVal: any) {
    this.vShowTaskCaption = pVal;
  };
  this.setShowEndWeekDate = function (pVal: any) {
    this.vShowEndWeekDate = pVal;
  };
  this.setShowWeekends = function (pVal: any) {
  ...
  this.setShowDeps = function (pVal: any) {
    this.vShowDeps = pVal;
  };
  this.setDateInputFormat = function (pVal: any) {
    this.vDateInputFormat = pVal;
  };
  this.setDateTaskTableDisplayFormat = function (pVal: any) {
    this.vDateTaskTableDisplayFormat = parseDateFormatStr(pVal);
  };
  this.setDateTaskDisplayFormat = function (pVal: any) {
    this.vDateTaskDisplayFormat = parseDateFormatStr(pVal);
  };
  this.setHourMajorDateDisplayFormat = function (pVal: any) {
    this.vHourMajorDateDisplayFormat = parseDateFormatStr(pVal);
  };
  this.setHourMinorDateDisplayFormat = function (pVal: any) {
    this.vHourMinorDateDisplayFormat = parseDateFormatStr(pVal);
  };
  this.setDayMajorDateDisplayFormat = function (pVal: any) {
    this.vDayMajorDateDisplayFormat = parseDateFormatStr(pVal);
  };
  this.setDayMinorDateDisplayFormat = function (pVal: any) {
    this.vDayMinorDateDisplayFormat = parseDateFormatStr(pVal);
  };
  this.setWeekMajorDateDisplayFormat = function (pVal: any) {
    this.vWeekMajorDateDisplayFormat = parseDateFormatStr(pVal);
  };
  this.setWeekMinorDateDisplayFormat = function (pVal: any) {
    this.vWeekMinorDateDisplayFormat = parseDateFormatStr(pVal);
  };
  this.setMonthMajorDateDisplayFormat = function (pVal: any) {
    this.vMonthMajorDateDisplayFormat = parseDateFormatStr(pVal);
  };
  this.setMonthMinorDateDisplayFormat = function (pVal: any) {
    this.vMonthMinorDateDisplayFormat = parseDateFormatStr(pVal);
  };
  this.setQuarterMajorDateDisplayFormat = function (pVal: any) {
    this.vQuarterMajorDateDisplayFormat = parseDateFormatStr(pVal);
  };
  this.setQuarterMinorDateDisplayFormat = function (pVal: any) {
  ...
  this.setTimer = function (pVal: any) {
    this.vTimer = pVal * 1;
  };
  this.setTooltipDelay = function (pVal: any) {
    this.vTooltipDelay = pVal * 1;
  };
  this.setTooltipTemplate = function (pVal: any) {
    this.vTooltipTemplate = pVal;
  };
  this.setMinDate = function (pVal: any) {
    this.vMinDate = pVal;
  };
  this.setMaxDate = function (pVal: any) {
    this.vMaxDate = pVal;
  };
  this.addLang = function (pLang, pVals) {
    if (!this.vLangs[pLang]) {
      this.vLangs[pLang] = new Object();
      for (let vKey in this.vLangs['en'])
        this.vLangs[pLang][vKey] = pVals[vKey]
          ? document.createTextNode(pVals[vKey]).data
          : this.vLangs['en'][vKey];
    }
  };
  this.setTotalHeight = function (pVal: any) {
  ...
  this.getShowTaskCaption = function () {
    return this.vShowTaskCaption;
  };
